...
class Manager extends Employee {
    ...
    addEmployee(emp) {
        if(Array.isArray(emp)) for(const e of emp) this.employees.push(e)
...
//CODE HERE
const manager = new Manager("Winston", "weekday afternoons")
...
//CODE HERE
// manager.addEmployee(['Coach', 'Cece', 'Schmidt'])
